                ...
                <div class="card " >
                    <div class="header bg-warning">
                        <h3 class="text-center">
                            <span class="glyphicon glyphicon-shopping-cart"></span> Orden de compra (Modo Edición)
                        </h3>
                    </div>
                   
                    <div class="body">
                        <form action="<?= base_url ?>documento/updateordencompra" method="POST"  id="FormularioAjaxDocumento" data-form="insert" enctype="multipart/form-data" autocomplete="off" >
                            <div class="row clearfix">
                                <!--<form >-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line focused error">
                                                <input type="text" class="form-control" id="txttipocambio" name="txttipocambio" value="<?= $documento->getTipocambio(); ?>" required="" >
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line focused error">
                                                <input type="number" class="form-control" id="txtgarantia" name="txtgarantia" value="<?= $documento->getGarantia() ?>" required="" >
...
<!--                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center exportacion">
                                    ...
                                    <button class="btn btn-lg btn-warning waves-effect">ACTUALIZAR COMPROBANTE</button>
                                    <a href="<?= base_url?>documento/selectordencompra" class="btn btn-lg btn-danger waves-effect">REGRESAR</a>
