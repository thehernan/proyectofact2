                ...
                <div class="card">
                    <div class="header">
                        <h1 class="text-center">
                            <span class="glyphicon glyphicon-shopping-cart"></span> Emitir cotización
                            <!--<small>Edición</small>-->
                    ...
                    <div class="body">
                        <form action="<?= base_url ?>documento/insertcotizacion" method="POST"  id="FormularioAjaxDocumento" data-form="insert" enctype="multipart/form-data" autocomplete="off" >
                            <div class="row clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line ">
                                                <input type="text" class="form-control" id="txtatencion" name="txtatencion" value=""  >
                                ...
                                <div class="h4 text-danger">DATOS DEL CLIENTE</div>
                                <hr>
                                <div class="row">
