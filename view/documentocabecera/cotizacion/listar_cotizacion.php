            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <hr>
                        <a class="btn btn-sm bg-deep-purple waves-effect" href="<?= base_url ?>documento/cotizacion"><span class="glyphicon glyphicon-plus "></span> Nuevo</a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                            <div class="form-group form-float">
                                ...
                                <select  class="form-control show-tick" id="cbtipocomprobante" name="cbtipocomprobante">
                                    ...
                                    <?php 
                                    $pred= array('Cotización');
                                    $value= array('Cotizacion');
...
<!--                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">-->
                                            <input type="hidden" class="form-control" id="txtserie" name="txtserie">
<!--                                        </div>
                                    </div>
