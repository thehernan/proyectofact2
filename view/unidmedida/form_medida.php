    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
                    ...
                    <div class="body">
                        <form action="<?= base_url . $url ?>" method="POST"  id="FormularioAjax" data-form="<?= $data ?>" enctype="multipart/form-data" autocomplete="off" >
                            <div class="row clearfix">
                                <!--<form >-->
                                <div class="row">
                                    <input type="hidden" value="<?= $medida->getId(); ?>" id="id" name="id">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line focused error">
                                                <input type="text" class="form-control" id="txtdescripcionunid" name="txtdescripcionunid" value="<?= $medida->getDescripcion(); ?>" required="">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line focused error">
                                                <input type="text" class="form-control" id="txtcodunid" name="txtcodunid" value="<?= $medida->getCodigo(); ?>" required="">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line focused error">
                                                <input type="text" class="form-control" id="txtordenunid" name="txtordenunid" value="<?= $medida->getOrden(); ?>" required="">
            ...
            <!--                            <input type="checkbox" id="remember_me_5" class="filled-in">
                                        ...
                                        <a href="<?= base_url ?>medida/select"  class="btn btn-danger btn-lg m-l-15 waves-effect" id="btncancelar">CANCELAR</a>
                                    </div>
                                </div>
                                <!--</form>-->
                            </div>
