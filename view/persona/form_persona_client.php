                        ...
                        <form action="<?= base_url . $url ?>" method="POST"  id="FormularioAjax" data-form="<?= $data ?>" enctype="multipart/form-data" autocomplete="off" >
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 ">
                                    <input type="hidden" value="<?= $persona->getId(); ?>" id="id" name="id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group form-float">
                                        <label class="form-label">Aniversario/Cump.</label>
...
?>
        ...
        <!--                            <input type="checkbox" id="remember_me_5" class="filled-in">
                                    ...
                                    <a href="<?= base_url ?>persona/selectclient"  class="btn btn-danger btn-lg m-l-15 waves-effect" id="btncancelar">CANCELAR</a>
                                </div>
                                <!--</form>-->
                            </div>
                        </form>
