                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="tablabancos">
                                ...
                                <tbody>
                                    ...
                                    foreach ($bancos as $banco) {
                                        echo '<tr>';
                                        echo '<td>' . $i . '</td>';
                                        echo '<td>' . $banco->getNombre() . '</td>';
                                 
                                        echo '<td><a href="' . base_url . 'bancos/cargar&id=' . $banco->getId() . '" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                        $i++;
                                    }
                                    ?>
